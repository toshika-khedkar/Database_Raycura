...
#### comboBox
        ...
        #     edit_button.clicked.connect(lambda _, row=row: self.edit_user(row))
        #     delete_button.clicked.connect(lambda _, row=row: self.delete_user(row))
    ...
    def onSelectButtonClicked(self, user_name):
        self.main_window.updateTabName(user_name)
